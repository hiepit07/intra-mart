...
public class FormSei0103d01 {
  ...
  private String condNyukinYoteibi;        // 入金予定日
  ...
  /**
   * condNyukinYoteibi getter
   */
  public String getCondNyukinYoteibi() {
    return condNyukinYoteibi;
  }

  /**
   * condNyukinYoteibi setter
   */
  public void setCondNyukinYoteibi(String condNyukinYoteibi) {
    this.condNyukinYoteibi = condNyukinYoteibi;
  }
