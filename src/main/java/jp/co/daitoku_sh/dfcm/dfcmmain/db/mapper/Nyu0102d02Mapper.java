 ...
 *
 */
public interface Nyu0102d02Mapper {
   ...
   * @return 検索結果
   */
  List<NyuSeikyusakiInfo> getShimeSeikyusakiList(Map<String, Object> params);
