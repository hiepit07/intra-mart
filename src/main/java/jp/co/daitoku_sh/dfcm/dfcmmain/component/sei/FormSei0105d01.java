...
public class FormSei0105d01 {
  ...
  private int haitaCount;             // 排他レコード数
  ...
  private TorimatomeSeikyusakiInfo torimatomeInfo;
   ...
   * haitaCount setter
   */
  public void setHaitaCount(int haitaCount) {
    this.haitaCount = haitaCount;
  }
  ...
  /**
   * torimatomeInfo getter
   */
  public TorimatomeSeikyusakiInfo getTorimatomeInfo() {
    return torimatomeInfo;
  }

  /**
   * torimatomeInfo setter
   */
  public void setTorimatomeInfo(TorimatomeSeikyusakiInfo torimatomeInfo) {
    this.torimatomeInfo = torimatomeInfo;
  }
